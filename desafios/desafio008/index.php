...
<body>
    ...
    <main>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="get">
            ...
            <input type="number" name="v1" id="idV1" required Value="<?php echo"$v1" ?>">

            <label for="p1">1º peso: </label>
            <input type="number" name="p1" id="idP1" required Value="<?php echo"$p1" ?>">

            <label for="v2">2º valor: </label>
            <input type="number" name="v2" id="idV2" required Value="<?php echo"$v2" ?>">

            <label for="p2">2º peso: </label>
            <input type="number" name="p2" id="idP2" required Value="<?php echo"$p2" ?>">
